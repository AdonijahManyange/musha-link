...
const features = [
  {
    ...
    description:
      "Every property is reviewed before it appears on MushaLink.",
  },
  {
    icon: BadgeCheck,
    title: "Trusted Landlords",
    description:
      "Verified landlord profiles help students avoid scams.",
  },
  {
    icon: MapPin,
  ...
  },
  {
    ...
    description:
      "Questions? We're here to help throughout your search.",
  },
];
  ...
  return (
    <section id="about" className="bg-white py-20">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="-mx-6 flex gap-4 overflow-x-auto px-6 pb-4 snap-x snap-mandatory scrollbar-hide md:hidden">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="w-[82vw] min-w-[82vw] snap-start rounded-2xl border border-slate-200 bg-slate-50 p-7 shadow-sm"
              >
